...
// Lo primero es definir los atributos que van a caractarizar a este objeto
...
public class Vendedor {
    ...
    private Double comisiones; // definir otros atributos para hacer calculos
    private Double sueldoMensual;
    private Date fechaInicio;
    
    //armar los  >>> constructores por defecto

    public Vendedor() {
    }
    
    // armar >> constructor por parámetros
